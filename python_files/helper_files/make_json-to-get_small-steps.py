...
examples = {
    "Create a folder \"Test_1/\" in the \"Testing/\" folder then create a file \"Test_253.txt\" in the \"Test_1/\" folder and hide the \"Test_1/\" folder": "To create a folder \"Test_1/\" in the \"Testing/\" folder then create a file \"Test_253.txt\" in the \"Test_1/\" folder and hide the \"Test/\" folder use step ```steps { Create a folder \"Test_1/\" in the \"Testing/\" folder }, { create a file \"Test_253.txt\" in the \"Testing/Test_1/\" folder }, { hide the \"Test_1/\" folder in the \"Testing/\" folder }```",
...
KB = [{
    ...
    "examples": examples,
    "Note": "Answer the query if and only if it can be done by the knowledge base of the classes available in your knowledge base. Ensure to consider small tasks of same category a single task if they come after one another. DO NOT create new knowledge bases to answer user query"
}]
