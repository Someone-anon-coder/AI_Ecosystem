...
PYBIND11_MODULE(angel_configure, m) {
    py::class_<File>(m, "File")
        .def(py::init<>())
        .def("_create_file", &File::_create_file)
        .def("_write_file", &File::_write_file)
        .def("_read_file", &File::_read_file)
        .def("_delete_file", &File::_delete_file)
        .def("_rename_file", &File::_rename_file)
        .def("_move_file", &File::_move_file)
        .def("_copy_file", &File::_copy_file)
        .def("_check_file", &File::_check_file)
        .def("_hide_file", &File::_hide_file)
        .def("_unhide_file", &File::_unhide_file);

    py::class_<Folder>(m, "Folder")
        .def(py::init<>())
        .def("_create_folder", &Folder::_create_folder)
        .def("_list_folder", &Folder::_list_folder)
        .def("_delete_folder", &Folder::_delete_folder)
        .def("_rename_folder", &Folder::_rename_folder)
        .def("_move_folder", &Folder::_move_folder)
        .def("_copy_folder", &Folder::_copy_folder)
        .def("_check_folder", &Folder::_check_folder)
        .def("_hide_folder", &Folder::_hide_folder)
        .def("_unhide_folder", &Folder::_unhide_folder);
    
    py::class_<GoogleNews>(m, "GoogleNews")
        .def(py::init<std::string, std::string, std::string, std::string, std::string, int, std::vector<std::string>>())
        ...
        .def("_get_news", &GoogleNews::_get_news)
        .def("_get_latest_topics", &GoogleNews::_get_latest_topics)
        .def("_get_news_by_topic", &GoogleNews::_get_news_by_topic)
        .def("_get_news_by_country", &GoogleNews::_get_news_by_country)
        .def("_get_news_by_site", &GoogleNews::_get_news_by_site)
    ...
    py::class_<GoogleSearch>(m, "GoogleSearch")
        .def(py::init<std::string, int, int, int, int, int, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string>())
