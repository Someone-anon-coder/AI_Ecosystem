...
std::map<std::string, std::map<std::string, std::string>> GoogleSearch::__class_info__(){
    ...
    std::map<std::string, std::string> __function_parameters__ = { // Function names and parameters
        ...
        {"_set_num_results", "num_results (int)"},
        {"_set_start_index", "start_index (int)"},
        {"_set_filter", "filter (int)"},
        {"_set_c2coff", "c2coff (int)"},
        {"_set_date_restrict", "date_restrict (int)"},
        {"_set_extra_query", "extra_query (string)"},
        {"_set_exact_terms", "exact_terms (string)"},
        {"_set_exclude_terms", "exclude_terms (string)"},
        {"_set_site_search", "site_search (string)"},
        {"_set_site_search_filter", "site_search_filter (string)"},
        {"_set_link_site", "link_site (string)"},
        {"_set_or_terms", "or_terms (string)"},
        {"_set_date_restrict_type", "date_restrict_type (string)"},
        {"_set_low_range", "low_range (string)"},
        {"_set_high_range", "high_range (string)"},
        {"_set_search_type", "search_type (string)"},
        {"_set_filetype", "filetype (string)"},
        {"_set_rights", "rights (string)"},
        {"_set_img_size", "img_size (string)"},
        {"_set_img_type", "img_type (string)"},
        {"_set_img_color_type", "img_color_type (string)"},
        {"_set_img_dominant_color", "img_dominant_color (string)"},
        {"_set_language", "language (string)"},
        {"_set_interface_language", "interface_language (string)"},
        {"_set_user_country", "user_country (string)"},
        {"_set_result_country", "result_country (string)"},
        {"_set_safe", "safe (string)"},
        {"_set_sort", "sort (string)"},
        {"_set_response_file", "json_file (string)"},
        {"_set_env_file", "env_file (string)"},
        {"_search_google", "query (string)\njson_file (string)"},
